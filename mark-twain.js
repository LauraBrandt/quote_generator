...
changeQuote = function() {
  var newQuote = chooseNewQuote()
  $('#quotetext').html(newQuote)
};

chooseNewQuote = function() {
  index = Math.floor(Math.random() * quotes.length);
  return (quotes[index]);
}

var quotes = ["Now what I contend is that my body is my own, at least I have always so regarded it. If I do harm through my experimenting with it, it is I who suffer, not the state.",
